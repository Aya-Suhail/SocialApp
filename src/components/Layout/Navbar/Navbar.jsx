...
const Navbar = () => {
  ...
  // جلب setToken بشكل آمن بدون إلقاء Exception
  let setToken = auth?.setToken;
  ...
  return (
    <nav className="bg-neutral-primary  w-full z-20 top-0 start-0 border-b border-default">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        >
          <span className="self-center text-3xl text-heading text-sky-800 font-bold whitespace-nowrap">
            Social App
          </span>
        </a>
        ...
        <div className="flex flex-wrap">
          <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            {/* التعديل هنا: حطينا الزرار والقائمة في div واخد relative */}
                ...
                >
                  ...
                  <li>
                    <a
                      ...
                      className="inline-flex cursor-pointer items-center text-red-900 w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded"
                    >
                      Sign out
                    </a>
                  </li>
          ...
          >
            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-default rounded-base bg-neutral-secondary-soft md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-neutral-primary">
              <li>
                <Link
                  to={"/home"}
                  className="block py-2 px-3 mx-7 text-heading rounded hover:bg-neutral-tertiary md:hover:bg-transparent md:border-0 md:hover:text-fg-brand md:p-0"
                >
                  Home
                </Link>
              </li>
